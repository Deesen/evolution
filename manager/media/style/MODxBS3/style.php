...
$modx->config['mgr_date_picker_path'] = sprintf('media/script/air-datepicker/datepicker.inc.php',$modx->config['manager_theme']);
...
$_style['icons_resource_duplicate'] = 'fa fa-files-o';
...
$_style['icons_save']               = 'fa fa-floppy-o';
